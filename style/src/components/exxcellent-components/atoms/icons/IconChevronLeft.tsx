...
export const IconChevronLeft: React.FC<IconProps> = ({
	...
	return (
		<svg height={height} width={width} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ ...style, marginBottom: offset }}>
			<g fill={color}>
				<g id="Outline_Icons">
					<path d="M23.501 23.5L12.001 12 23.501.5" fill="none" stroke={color} strokeLinecap="round"/>
					<path d="M12.001 23.5L.501 12 12.001.5" fill="none" stroke={color} strokeLinecap="round"/>
				</g>
