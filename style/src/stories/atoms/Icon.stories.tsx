...
import {Icon, IconProps, availableIcons, IconActorEdit} from '../../components/exxcellent-components/atoms';
  ...
  <>
    <table style={{ width: "100%" }}>
      ...
      <tr>
        ...
        <td style={{ fontSize: "3em"}}>
          <Icon name={'actor-add'} color={'#00FF00'} />
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td style={{ fontSize: "3em"}}>
          <Icon name={'actor-add'} color={'rgba(0,0,255, .5)'} />
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <td style={{ fontSize: "2em"}}>
          Inline <Icon name={'actor-add'} verticalOffset={20} /> example
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td style={{ fontSize: "2em"}}>
          <Icon name={'actor-add'} style={{ rotate: "45deg", border: "3px dashed red"}} />
        </td>
      </tr>
      </tbody>
    </table>
