        ...
        <table style={{width: "100%"}}>
            <tr>
                <td className={"padding-s"}>
                    <Bar color={"primary"}
                         height={"large"}
                         left={<span>{"color=\"primary\""}</span>}
                         right={<span>{"height=\"large\""}</span>}
                    />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td className={"padding-s"}>
                    <Bar color={"secondary"}
                         height={"large"}
                         left={<span>{"color=\"secondary\""}</span>}
                         right={<span>{"height=\"large\""}</span>}
                    />
                </td>
            </tr>
...
export const SpecificBarTypes = () => (
    <>
        <table style={{width: "100%"}}>
            <tr>
                <td className={"padding-s"}>
                    <PrimaryBar height={"large"}
                                left={<span>&lt;PrimaryBar /&gt;</span>}
                                right={<span>{"height=\"large\""}</span>}
                    />
                </td>
            </tr>
            ...
            <tr>
                <td className={"padding-s"}>
                    <SecondaryBar height={"large"}
                                  left={<span>&lt;SecondaryBar /&gt;</span>}
                                  right={<span>{"height=\"large\""}</span>}
                    />
                </td>
            </tr>
            ...
            <tr>
                <td className={"padding-s"}>
                    <TertiaryBar height={"large"}
                                 left={<span>&lt;TertiaryBar /&gt;</span>}
                                 right={<span>{"height=\"large\""}</span>}
                    />
                </td>
            </tr>
