...
export const ControllPanelEditCondition: FunctionComponent<ControllPanelEditConditionProps> = (props) => {
  ...
  const conditionName = (
    <OptionField label1="Condition - name">
      <Carv2LabelTextfield
        label="Name:"
  ...
  const hasDropDown = (
    <OptionField label1="Codition - true / false">
      <Dropdown
        options={[
  ...
  const dropDowns = (
    <div className="optionFieldSpacer columnDivider">
      <div style={{ display: "flex" }}>
        <OptionField label1="Select a component">
          <ComponentDropDown
            onSelect={(comp) => {
              setComponent(comp);
              updateCondition();
        ...
        <OptionField label1="Select data for component">
