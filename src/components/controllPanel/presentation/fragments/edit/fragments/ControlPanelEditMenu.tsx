    ...
    return (
        <ControlPanel>
            <OptionField label="actor">
                <AddOrEdit label={"Actor"}
                           addCallBack={() => editOrAddActor()}
                           dropDown={<ActorDropDownButton onSelect={editOrAddActor}
                                                          icon="wrench"
                           />}
                />
            </OptionField>
            <OptionField label="Data"
                         divider={true}
            >
                <AddOrEdit label={"Data"}
                           addCallBack={() => editOrAddData()}
                           dropDown={<DataDropDownButton onSelect={editOrAddData}
                                                         icon="wrench"
                           />}
                />
                <AddOrEdit label={"Relation"}
                           addCallBack={() => editOrAddRelation()}
                           dropDown={<RelationDropDownButton onSelect={editOrAddRelation}
                                                             icon="wrench"
                           />}
                />
            </OptionField>
            <OptionField label="Data - Setup"
                         divider={true}
            >
                <AddOrEdit label={"Data Setup"}
                           addCallBack={() => editOrAddDataSetup()}
                           dropDown={<DataSetupDropDownButton onSelect={editOrAddDataSetup}
                                                              icon="wrench"
                           />}
                />
            </OptionField>
            <OptionField label="sequence"
                         divider={true}
            >
                <AddOrEdit label={"Sequence"}
                           addCallBack={() => editOrAddSequence()}
                           dropDown={<SequenceDropDownButton
                               onSelect={(sequenceTO) => editOrAddSequence(sequenceTO?.id)}
                               icon="wrench"
                           />}
                />
                <AddOrEdit label={"Chain"}
                           addCallBack={() => editOrAddChain()}
