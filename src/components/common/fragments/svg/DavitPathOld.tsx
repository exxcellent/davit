...
import { DataRelationTO, Direction } from '../../../../dataAccess/access/to/DataRelationTO';

export interface DavitPathOldProps {
    xSource: number;
    ySource: number;
    xTarget: number;
    yTarget: number;
...
const DavitPathOld: FunctionComponent<DavitPathOldProps> = (props) => {
    const {
        xSource,
        ySource,
        xTarget,
