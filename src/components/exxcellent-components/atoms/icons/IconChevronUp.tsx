...
export const IconChevronUp: React.FC<IconProps> = ({
	...
	return (
		<svg height={height} width={width} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ ...style, marginBottom: offset }}>
			<g fill={color}>
				<g id="Outline_Icons">
					<path d="M.501 23.5l11.5-11.5 11.5 11.5" fill="none" stroke={color} strokeLinecap="round"/>
					<path d="M.501 12L12.001.5l11.5 11.5" fill="none" stroke={color} strokeLinecap="round"/>
				</g>
