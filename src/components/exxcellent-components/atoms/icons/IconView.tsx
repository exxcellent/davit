		...
		<svg height={height} width={width} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ ...style, marginBottom: offset }}>
			<g fill={color}>
				<g id="Outline_Icons_1_">
					<g id="Outline_Icons">
						<path d="M23.5 12s-5.148 6.5-11.5 6.5S.5 12 .5 12 5.648 5.5 12 5.5 23.5 12 23.5 12z" fill="none" stroke={color} strokeLinecap="round"/>
						<circle cx="12" cy="12" fill="none" r="4" stroke={color} strokeLinecap="round"/>
					</g>
				</g>
