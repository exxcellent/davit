...
export const SecondaryBar: React.FC<PredefinedBarProps> = (props: PredefinedBarProps) => {
    const barProps: BarProps = {...props, color: "secondary"};
