...
export const useGetModelChainLinkTableData = (selectedChainlinks: ChainlinkCTO[], selectedChainDecisions: ChainDecisionTO[]) => {
...
const createLinkColumn = (link: ChainlinkCTO, selectedChainlinks: ChainlinkCTO[],
    selectedChainDecisions: ChainDecisionTO[], editCallback: ()=>void): DavitTableRowData => {
