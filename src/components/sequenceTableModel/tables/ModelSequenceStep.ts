...
export const useGetStepTableData = (selectedSequence: SequenceCTO | null): {header: string[], bodyData: DavitTableRowData[]} => {
...
const createModelStepColumn = (step: SequenceStepCTO, selectedSequence: SequenceCTO, editCallback: ()=> void): DavitTableRowData => {
