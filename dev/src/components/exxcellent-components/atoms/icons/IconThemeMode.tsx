...
export const IconThemeMode: React.FC<IconProps> = ({
	...
	return (
				<svg height={height} width={width} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ ...style, marginBottom: offset }}>
					<g fill={color}>
						<g id="Outline_Icons">
							<path d="M19.5 15.106L22.606 12 19.5 8.894V4.5h-4.394L12 1.394 8.894 4.5H4.5v4.394L1.394 12 4.5 15.106V19.5h4.394L12 22.606l3.106-3.106H19.5z" fill="none" stroke={color}/>
							<path d="M11.5 6c4 0 6 2.687 6 6s-2 6-6 6V6z" fill="none" stroke={color}/>
						</g>
