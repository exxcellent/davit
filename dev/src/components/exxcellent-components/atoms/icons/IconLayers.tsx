		...
		<svg height={height} width={width} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ ...style, marginBottom: offset }}>
			<g fill={color}>
				<g id="Outline_Icons_1_">
					<g id="Outline_Icons">
						<path d="M23.5 10.5l-11.5 5-11.5-5" fill="none" stroke={color} strokeLinecap="round"/>
						<path d="M23.5 13.5l-11.5 5-11.5-5" fill="none" stroke={color} strokeLinecap="round"/>
						<path d="M23.5 16.5l-11.5 5-11.5-5" fill="none" stroke={color} strokeLinecap="round"/>
						<path d="M12 12.5L.5 7.5l11.5-5 11.5 5z" fill="none" stroke={color} strokeLinecap="round"/>
					</g>
				</g>
